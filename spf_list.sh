...
echo -e "$gplus looking up SPF records for domain [ $green ${initial_domain} $reset ]"
echo -e "$bplus IP addresses allowed to send from domain $blue ${initial_domain} $reset"
echo -e ""
